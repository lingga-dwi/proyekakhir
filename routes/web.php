...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/designer/proyek/heartbeat', [DashboardController::class, 'designerProjectsHeartbeat'])
        ->name('designer.projects.heartbeat')->middleware('role:designer');
    ...
    Route::middleware(['role:pelanggan'])->group(function () {
        ...
        Route::post('/pemesanan/{pemesanan}/tagihan/{invoice}/bukti-pembayaran', [PemesananController::class, 'uploadInvoiceEvidence'])
            ->name('pemesanan.invoice-evidence.upload')->middleware('throttle:customer-forms');
    ...
    // Catalog management routes — accessible to admin and designer roles
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::get('/admin/pemesanan/heartbeat', [PemesananController::class, 'heartbeat'])->name('admin.pemesanan.heartbeat');
        ...
        Route::post('/admin/pemesanan/{pemesanan}/validasi/kirim', [PemesananController::class, 'validateDraft'])
        ...
        Route::post('/admin/pemesanan/konsultasi/{konsultasi}/selesai', [KonsultasiController::class, 'completeByDesigner'])
            ->name('admin.pemesanan.konsultasi.complete');
        Route::delete('/admin/pemesanan/konsultasi/{konsultasi}', [KonsultasiController::class, 'destroy'])
            ->name('admin.pemesanan.konsultasi.destroy');
