<div id="historyModal" class="fixed inset-0 z-70 hidden items-center justify-center bg-slate-950/50 p-4" role="dialog" aria-modal="true" aria-labelledby="history-modal-title">
    <div class="relative max-h-[85vh] w-full max-w-lg overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div class="flex items-start justify-between gap-4 border-b border-slate-100 px-5 py-4 sm:px-6">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500">Seluruh perubahan status dan keputusan tercatat di sini.</p>
            </div>
