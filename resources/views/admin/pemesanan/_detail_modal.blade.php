<div id="detailModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-950/50 p-4" role="dialog" aria-modal="true" aria-labelledby="detail-modal-title">
    <div class="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div class="mt-5 grid gap-5 sm:grid-cols-2">
            <section class="rounded-xl bg-slate-50 p-4">
                ...
                <dl class="mt-3 space-y-2 text-sm">
                    ...
                    <div><dt class="text-xs uppercase tracking-wide text-slate-400">Email &amp; WhatsApp</dt><dd id="detailModalContact" class="mt-0.5 break-words text-slate-700"></dd></div>
                    <div><dt class="text-xs uppercase tracking-wide text-slate-400">Alamat proyek</dt><dd id="detailModalAddress" class="mt-0.5 whitespace-pre-line text-slate-700"></dd></div>
                </dl>
            </section>
            <section class="rounded-xl bg-slate-50 p-4">
                <h3 class="text-sm font-semibold text-slate-900">Ringkasan kebutuhan</h3>
                <dl class="mt-3 grid gap-3 text-sm sm:grid-cols-2">
                    <div><dt class="text-xs uppercase tracking-wide text-slate-400">Jenis proyek</dt><dd id="detailModalProjectType" class="mt-0.5 font-medium text-slate-800"></dd></div>
                    <div><dt class="text-xs uppercase tracking-wide text-slate-400">Jenis bangunan</dt><dd id="detailModalBuilding" class="mt-0.5 font-medium text-slate-800"></dd></div>
                    <div><dt class="text-xs uppercase tracking-wide text-slate-400">Luas area</dt><dd id="detailModalArea" class="mt-0.5 text-slate-700"></dd></div>
                    <div><dt class="text-xs uppercase tracking-wide text-slate-400">Anggaran pelanggan</dt><dd id="detailModalRequestBudget" class="mt-0.5 text-slate-700"></dd></div>
                </dl>
            </section>
        </div>
        ...
        <section id="detailModalAttachments" class="mt-5 hidden rounded-xl border border-slate-200 p-4">
            <h3 class="text-sm font-semibold text-slate-900">Denah, foto, dan referensi</h3>
            <div id="detailModalAttachmentList" class="mt-3 grid gap-3 sm:grid-cols-2"></div>
        </section>
        ...
        <section id="detailModalProject" class="mt-5 hidden rounded-xl border border-slate-200 p-4">
            ...
            <dl class="mt-3 grid gap-3 text-sm sm:grid-cols-2">
                ...
                <div><dt class="text-xs uppercase tracking-wide text-slate-400">Nilai proyek</dt><dd id="detailModalBudget" class="mt-0.5 text-slate-700"></dd></div>
            </dl>
        </section>
