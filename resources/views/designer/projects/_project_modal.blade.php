            ...
            <div class="overflow-hidden rounded-xl border border-slate-200">
                <div class="p-3">
                    ...
                    <div class="mt-3 flex items-center justify-end gap-2 border-t border-slate-100 pt-3">
                        <button type="button" id="dpSendBtn" onclick="sendDpDocuments()" class="inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-50">
