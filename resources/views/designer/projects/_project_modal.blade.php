        ...
        <div class="mt-3">
            <div class="overflow-hidden rounded-xl border border-slate-200">
                <div class="p-3">
                    ...
                    <div class="mt-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-1 border-t border-slate-100 pt-3">
                        <button type="button" id="dpHistoryToggle" class="inline-flex items-center gap-1 text-xs font-semibold text-amber-700 hover:text-amber-800">
                            <i class="fas fa-clock-rotate-left text-[10px]" aria-hidden="true"></i> Riwayat Status
                        </button>
                    ...
                    <div id="dpHistoryPanel" class="mt-2 hidden max-h-32 space-y-2 overflow-y-auto rounded-xl border border-slate-200 p-3"></div>
                </div>
            </div>
        </div>
    </div>
