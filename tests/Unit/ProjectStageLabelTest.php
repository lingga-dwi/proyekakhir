...
class ProjectStageLabelTest extends TestCase
{
    ...
    public static function pemesananStageProvider(): array
    {
        return [
            ...
            'approved but still confirmed status = pengerjaan proyek' => [Pemesanan::STATUS_CONFIRMED, 'approved', 'Pengerjaan Proyek'],
            'approved and in progress status = pengerjaan proyek' => [Pemesanan::STATUS_IN_PROGRESS, 'approved', 'Pengerjaan Proyek'],
    ...
    public static function actorForProvider(): array
    {
        return [
            ...
            'approved / pengerjaan proyek' => [Pemesanan::STATUS_IN_PROGRESS, 'approved', 'Tim Lapangan'],
