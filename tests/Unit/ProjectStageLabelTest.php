...
class ProjectStageLabelTest extends TestCase
{
    ...
    public static function pemesananStageProvider(): array
    {
        return [
            ...
            'survey pending' => [Pemesanan::STATUS_CONFIRMED, 'survey_pending', 'Menunggu Jadwal Survei'],
            'survey scheduled' => [Pemesanan::STATUS_CONFIRMED, 'survey_scheduled', 'Survei Terjadwal'],
